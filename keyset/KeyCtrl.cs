...
namespace virtualKeyBoard.KeySet
{
    ...
    {
        private static KeyCtrl instance;
        public KeyCtrl()
        {
            InitializeComponent();
        }

        public static KeyCtrl GetForm
        {
            get
            {
                if (instance == null || instance.IsDisposed)
                    instance = new KeyCtrl();
                return instance;
            }
        }
        ...
        private void KeyCtrl_Click(object sender, EventArgs e)
        {
        ...
        private void KeyCtrl_MouseUp(object sender, MouseEventArgs e)
        {
