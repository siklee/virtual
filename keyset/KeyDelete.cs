...
{
    public partial class KeyDelete : Form
    {
        private static KeyDelete instance;
        public KeyDelete()
        {
            InitializeComponent();
        }

        public static KeyDelete GetForm
        {
            get
            {
                if (instance == null || instance.IsDisposed)
                    instance = new KeyDelete();
                return instance;
            }
        }
        ...
        private void KeyDelete_MouseUp(object sender, MouseEventArgs e)
        {
