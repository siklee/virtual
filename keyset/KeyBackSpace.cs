...
{
    public partial class KeyBackSpace : Form
    {
        private static KeyBackSpace instance;
        public KeyBackSpace()
        {
            InitializeComponent();
        }

        public static KeyBackSpace GetForm
        {
            get
            {
                if (instance == null || instance.IsDisposed)
                    instance = new KeyBackSpace();
                return instance;
            }
        }
        ...
        private void KeyBackSpace_MouseUp(object sender, MouseEventArgs e)
        {
