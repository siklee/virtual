...
namespace virtualKeyBoard.KeySet
{
    ...
    {
        private static KeyWindow instance;
        public KeyWindow()
        {
            InitializeComponent();
        }

        public static KeyWindow GetForm
        {
            get
            {
                if (instance == null || instance.IsDisposed)
                    instance = new KeyWindow();
                return instance;
            }
        }
        ...
        private void KeyWindow_Click(object sender, EventArgs e)
        {
        ...
        private void KeyWindow_MouseUp(object sender, MouseEventArgs e)
        {
