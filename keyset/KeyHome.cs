...
{
    public partial class KeyHome : Form
    {
        private static KeyHome instance;
        public KeyHome()
        {
            InitializeComponent();
        }

        public static KeyHome GetForm
        {
            get
            {
                if (instance == null || instance.IsDisposed)
                    instance = new KeyHome();
                return instance;
            }
        }
        ...
        private void KeyHome_MouseUp(object sender, MouseEventArgs e)
        {
