...
{
    public partial class KeyPageDown : Form
    {
        private static KeyPageDown instance;
        public KeyPageDown()
        {
            InitializeComponent();
        }

        public static KeyPageDown GetForm
        {
            get
            {
                if (instance == null || instance.IsDisposed)
                    instance = new KeyPageDown();
                return instance;
            }
        }
        ...
        private void KeyPageDown_MouseUp(object sender, MouseEventArgs e)
        {
