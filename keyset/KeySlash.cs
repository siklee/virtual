...
{
    public partial class KeySlash : Form
    {
        private static KeySlash instance;
        public KeySlash()
        {
            InitializeComponent();
        }

        public static KeySlash GetForm
        {
            get
            {
                if (instance == null || instance.IsDisposed)
                    instance = new KeySlash();
                return instance;
            }
        }
        ...
        private void KeySlash_MouseUp(object sender, MouseEventArgs e)
        {
