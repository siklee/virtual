...
{
    public partial class KeyPrintScreen : Form
    {
        private static KeyPrintScreen instance;
        public KeyPrintScreen()
        {
            InitializeComponent();
        }

        public static KeyPrintScreen GetForm
        {
            get
            {
                if (instance == null || instance.IsDisposed)
                    instance = new KeyPrintScreen();
                return instance;
            }
        }
        ...
        private void KeyPrintScreen_MouseUp(object sender, MouseEventArgs e)
        {
