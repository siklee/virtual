...
{
    public partial class KeyShift : Form
    {
        private static KeyShift instance;
        public KeyShift()
        {
            InitializeComponent();
        }

        public static KeyShift GetForm
        {
            get
            {
                if (instance == null || instance.IsDisposed)
                    instance = new KeyShift();
                return instance;
            }
        }
        ...
        private void KeyShift_MouseUp(object sender, MouseEventArgs e)
        {
